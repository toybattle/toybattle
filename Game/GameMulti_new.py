...
def gameMulti(screen, clock, gamedata):
    ...
    while True:
        ...
        # -----------------------------------------------------------
        # UI HAUT DROITE - COMPTEUR D'ÉTOILES
        # -----------------------------------------------------------
        stars_panel_rect = pygame.Rect(WIDTH - 250, 20, 230, 80)
        ...
        screen.blit(my_stars_txt, (WIDTH - 230, 30))
        screen.blit(enemy_stars_txt, (WIDTH - 230, 60))
