...
while True:
    ...
    # Defausse a droite de la map 
    pygame.draw.rect(screen, (20, 20, 25), (MAP_X - MAP_WIDTH/2 + 65, MAP_Y + 290, 120, 150), border_radius=8)
    pygame.draw.rect(screen, (80, 80, 100), (MAP_X - MAP_WIDTH/2 + 65, MAP_Y + 290, 120, 150), 2, border_radius=8)
    screen.blit(pioche, (MAP_X - MAP_WIDTH/2 + 75, MAP_Y + 300))
